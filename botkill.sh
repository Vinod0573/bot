...
# exec nohup python nohup nlu/emi_english/app.py &
# exec nohup python nohup nlg/emi_english/nlg_server.py &
...
# exec nohup python nohup nlu/emi_english/app_hindi.py &
# exec nohup python nohup nlg/emi_english/nlg_server_hindi.py &
...
# exec nohup python nohup nlu/emi_english/app_kannada.py &
# exec nohup python nohup nlg/emi_english/nlg_server_kannada.py &
...
# exec nohup python nohup nlu/emi_english/app_malayalam.py &
# exec nohup python nohup nlg/emi_english/nlg_server_malayalam.py &
...
# exec nohup python nohup nlu/emi_english/app_tamil.py &
# exec nohup python nohup nlg/emi_english/nlg_server_tamil.py &
...
# exec nohup python nohup nlu/emi_english/app_telugu.py &
# exec nohup python nohup nlg/emi_english/nlg_server_telugu.py &
...
# exec nohup python nohup nlu/emi_english/app_bengali.py &
# exec nohup python nohup nlg/emi_english/nlg_server_bengali.py &
...
# exec nohup python nohup nlu/emi_english/app_gujarati.py &
# exec nohup python nohup nlg/emi_english/nlg_server_gujarati.py &
...
# exec nohup python nohup nlu/emi_english/app_punjabi.py &
# exec nohup python nohup nlg/emi_english/nlg_server_punjabi.py &
...
# exec nohup python nohup nlu/emi_english/app_marathi.py &
# exec nohup python nohup nlg/emi_english/nlg_server_marathi.py &
